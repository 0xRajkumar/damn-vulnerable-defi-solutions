...
describe("[Challenge] Climber", function () {
  ...
  it("Exploit", async function () {
    ...
    const AttackerClimberFactory = await ethers.getContractFactory(
      "ClimberAttacker",
      attacker
    );
    const AttackerClimber = await AttackerClimberFactory.connect(
      attacker
    ).deploy(
    ...
    await AttackerClimber.connect(attacker).Attack();
  });
