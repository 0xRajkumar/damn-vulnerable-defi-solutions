...
describe("[Challenge] Free Rider", function () {
  ...
  it("Exploit", async function () {
    ...
    const AttackerRiderFactory = await ethers.getContractFactory(
      "AttackerRider",
      attacker
    );
    const AttackerRider = await AttackerRiderFactory.connect(attacker).deploy(
    ...
    await AttackerRider.connect(attacker).Attack();
  });
